...
# 4.0.2 GA
docker run -it -p 6399:6379 -p 7687:7687 -v /datadrive/redis_graph/notetaker_falkor_db/:/data  -e REDIS_ARGS="--dir /data --dbfilename dump.rdb" --name falkordb --rm falkordb/falkordb:v4.0.2
